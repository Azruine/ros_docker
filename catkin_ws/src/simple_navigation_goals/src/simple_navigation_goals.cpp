...
int main(int argc, char** argv){
  ...
  goal.target_pose.pose.position.x = 2.69;
  goal.target_pose.pose.position.y = 0.07;
//  goal.target_pose.pose.position.x = 8.88;
//  goal.target_pose.pose.position.y = -0.03;
  goal.target_pose.pose.orientation.w = 0.010; //Quaternion
  ROS_INFO("Sending goal 1");
  ac.sendGoalAndWait(goal, ros::Duration(80.0,0), ros::Duration(80.0,0));
